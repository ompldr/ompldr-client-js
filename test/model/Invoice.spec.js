...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Omploader.Invoice();
  });
  ...
  describe('Invoice', function() {
    it('should create an instance of Invoice', function() {
      ...
      //var instane = new Omploader.Invoice();
      //expect(instance).to.be.a(Omploader.Invoice);
    });
    ...
    it('should have the property invoiceExpiresAt (base name: "invoiceExpiresAt")', function() {
      // uncomment below and update the code to test the property invoiceExpiresAt
      //var instane = new Omploader.Invoice();
      //expect(instance).to.be();
    });
