...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Omploader.RefreshRequest();
  });
  ...
  describe('RefreshRequest', function() {
    it('should create an instance of RefreshRequest', function() {
      ...
      //var instane = new Omploader.RefreshRequest();
      //expect(instance).to.be.a(Omploader.RefreshRequest);
    });
    ...
    it('should have the property expiresAfterSeconds (base name: "expiresAfterSeconds")', function() {
      // uncomment below and update the code to test the property expiresAfterSeconds
      //var instane = new Omploader.RefreshRequest();
      //expect(instance).to.be();
    });
