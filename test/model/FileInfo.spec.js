...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Omploader.FileInfo();
  });
  ...
  describe('FileInfo', function() {
    it('should create an instance of FileInfo', function() {
      ...
      //var instane = new Omploader.FileInfo();
      //expect(instance).to.be.a(Omploader.FileInfo);
    });
    ...
    it('should have the property invoicePaid (base name: "invoicePaid")', function() {
      // uncomment below and update the code to test the property invoicePaid
      //var instane = new Omploader.FileInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property downloadsRemaining (base name: "downloadsRemaining")', function() {
